...
<header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#233648] px-10 py-3">
  ...
  <div class="flex flex-1 justify-end gap-8 items-center">
    ...
    <div class="flex gap-2">
      <!-- Burger -->
      <button class="flex items-center justify-center rounded-lg h-10 w-10 bg-[#233648] text-white">
...
export class NavbarComponent {
  @Input() avatarUrl =
    'https://lh3.googleusercontent.com/aida-public/AB6AXuD4vl6rEmC9vjtNrU91VjUawDJd7qQKF_Tl61w9N_C31jdn9dmXPnx_OHn33QRR1S4KRkXM3hzMDMpRo2_YCK3tyNIvYhM8YDaXdo23eJKMoZ3pI8C5n7YHULRWxTtK7Lsn6w0YqCwXQ41Erd7YdDRCz6MTvZUtXYhdi90O-0NKfiMcjU7mzPPKZ_sFBw1YtCES0unnMbc60IOGxkKFQsRi0mbsLARbNDb2c3u2j1Y5zw_kTA9awShpneHGjSZC8S6hpXLbwqgh6TY';
